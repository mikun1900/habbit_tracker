...
class TaskExecutionLocalDataSource {
  ...
  /// 実行記録を挿入
  ///
  /// [executionMap]: 実行記録データ（id, task_id, executed_atなど）
  /// 戻り値: なし
  ...
  /// [startDate]: 開始日時
  /// [endDate]: 終了日時
  /// [taskId]: タスクID（指定時のみ該当タスクの記録を取得、nullで全タスク対象）
  /// 戻り値: 期間内の実行記録リスト（昇順）
  ...
  /// [startDate]: 開始日時
  /// [endDate]: 終了日時
  /// [taskId]: タスクID（指定時のみ該当タスク対象、nullで全タスク対象）
  /// 戻り値: 日付をキー、実行回数を値とするMap（例："2026-01-24" -> 3）
